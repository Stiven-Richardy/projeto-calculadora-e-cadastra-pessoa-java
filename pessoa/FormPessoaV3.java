...
public class FormPessoaV3 extends JFrame {
    ...
    private JRadioButton rbMasculino = new JRadioButton("M", true);
    private JRadioButton rbFeminino = new JRadioButton("F", false);
    ...
    private void cadastraPessoa() {
        ...
        try {
            char sexoSelecionado = rbMasculino.isSelected() ? 'M' : 'F';

            Pessoa umaPessoa = new Pessoa(nome, sexoSelecionado, idadeNum);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FormPessoaV3().setVisible(true));
    }
}